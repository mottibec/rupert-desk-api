...
var authenticationController = /** @class */ (function () {
    ...
    authenticationController.prototype.signUp = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var signUpData, savedUser, _a, user, account, userResult, accountResult, token;
    ...
    authenticationController.prototype.createUser = function (signUpData) {
        return __awaiter(this, void 0, void 0, function () {
            var instagramData, user, account, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this._igService.getUserInfo(signUpData.instagram)];
                    case 1:
                        instagramData = _b.sent();
                        user = {
                    ...
                    case 2:
                        _a.password = _b.sent();
                        return [2 /*return*/, { user: user, account: account }];
                }
            });
        });
    };
